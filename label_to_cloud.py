...
colors = np.concatenate([colors.astype(np.int8), np.ones([colors.shape[0], 1]) * 255], axis=1)
file_id = '000010'
scan_dir = f'/media/mmohseni/ubuntu/projects/thesis/simple_kitti_visualization/examples/kitti/velodyne/{file_id}.bin'
im_path = f'/media/mmohseni/ubuntu/projects/thesis/simple_kitti_visualization/examples/kitti/image_2/{file_id}.png'
label_dir = f'/media/mmohseni/ubuntu/projects/thesis/simple_kitti_visualization/examples/kitti/label_2/{file_id}.txt'
calib_path = f'/media/mmohseni/ubuntu/projects/thesis/simple_kitti_visualization/examples/kitti/calib/{file_id}.txt'
